...
test_that("persuasio4ytz bootstrap respects external RNG state", {
  set.seed(42)
  res1 <- persuasio4ytz(y = "y", t = "t", z = "z", method = "bootstrap", nboot = 200, data = df)
  set.seed(42)
  res2 <- persuasio4ytz(y = "y", t = "t", z = "z", method = "bootstrap", nboot = 200, data = df)
...
test_that("persuasio wrapper routes to yz with y, z, x order", {
  res <- persuasio(
    est = "yz", y = "y", z = "z", x = "x1",
    data = df, method = "bootstrap", nboot = 5
  )
